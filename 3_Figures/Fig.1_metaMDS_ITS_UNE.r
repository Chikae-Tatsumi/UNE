...
annotate("text", x=Inf, y=Inf, hjust=1, vjust =2, label=DFB.result, size=5) +
annotate("text", x=Inf, y=Inf, hjust=1, vjust =4, label=DFE.result, size=5) +
annotate("text", x=Inf, y=Inf, hjust=1, vjust =6, label=DFBDFE.result, size=5) 
