...
setwd("~/R/Analysis/2_UNE/ITS")  #Change
objective <- read.csv("aggregated.family.table.csv", header=T, row.names=1) #Change
...
# Save
write.csv(Results.asterisk, "lmer.ITS.family.csv") #Change
