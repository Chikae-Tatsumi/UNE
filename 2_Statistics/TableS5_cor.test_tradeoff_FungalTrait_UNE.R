...
Pros <- cbind(data$ECM, data$Saprotroph, 
data$soil_saprotroph, data$wood_saprotroph, data$litter_saprotroph, data$dung_saprotroph)
Cons <- cbind(data$Plant_pathogenic_capacity,	data$Animal_parasite)
