...
objective <- read.csv("metadata.csv", header=T) #Change
...
names(Bind) <- c(paste(NAME1,".estimate",sep=""),paste(NAME1,".F",sep=""),paste(NAME1,".P",sep=""),paste(NAME2,".estimate",sep=""),paste(NAME2,".F",sep=""),paste(NAME2,".P",sep=""),paste(NAME1,"*",NAME2,".estimate",sep=""),paste(NAME1,"*",NAME2,".F",sep=""),paste(NAME1,"*",NAME2,".P",sep=""))
...
# Save
write.csv(Results.asterisk, "lmer.metadata.csv") #Change
