...
fg <- read.csv("~/R/Database/bacteria_func_groups.csv") #Changed
# Albright et al. N-cycle pathway presence/absence
N_cyclers_raw <-  read.csv("~/R/Database/Npathways_Albright2018.csv",  #Changed
                           stringsAsFactors = FALSE)
# Berlemont and Martiny cellulolytic pathway presence/absence
cellulolytic_raw <-  read.csv("~/R/Database/cellulolytic_Berlemont.csv") #Changed
...
# save output
saveRDS(fg_out,"bacteria_tax_to_function.rds")
